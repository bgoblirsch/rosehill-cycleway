...
const MoreInfo: React.FC = () => {
  ...
  return (
    <Wrapper>
        ...
        <Disclaimer>The data for the ward boundaries and existing bike routes were sourced from the <StoryLink to="https://data.cityofchicago.org/" text="Chicago Data Portal"></StoryLink> and the existing bike route data received a few edits to better better reflect the actual bike network. All other data was manually digitized for the purpose of this proposal.</Disclaimer>
