...
const Route: React.FC = () => {
  return (
    <Wrapper>
        ...
        <p><StoryLink to="https://www.chicagotribune.com/columns/ct-bike-lane-network-getting-around-met-1012-20151011-column.html" text="$200,000 per mile was CDOT's cost estimate for protected bike lanes in 2015."/> Phase 1 is roughly 0.91 miles in length, making for an inflation-adjusted initial cost estimate of around $224,000.</p>
