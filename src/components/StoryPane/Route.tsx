...
const Route: React.FC = () => {
  return (
    <Wrapper>
        ...
        <p><StoryLink to="https://www.chicagotribune.com/columns/ct-bike-lane-network-getting-around-met-1012-20151011-column.html" text="In 2015, CDOT's cost estimate"/> for 1 mile of protected bike lane was $200,000 per mile. Phase 1 is roughly 0.91 miles in length, making for an inflation-adjusted initial cost estimate of around $224,000.</p>
        ...
        <p>Phase 2B has already been identified as a potential two-way protected bike route on Western Avenue between Bedwyn Ave and Ardmore Avenue.</p>
