        ...
        <Legend>
          <LegendItem>       
            <svg height="10" width="30">
              <line stroke="blue" stroke-width="4" x1="0" y1="5" x2="30" y2="5" />
            </svg> 
            Existing Bike Route
          </LegendItem>
          <LegendItem>
